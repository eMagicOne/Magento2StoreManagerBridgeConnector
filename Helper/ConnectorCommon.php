...
/**
 * Class which has common connector functionality
 */
class ConnectorCommon
{
    ...
    const QOUTE_CHAR                         = '"';
    const LOG_FILENAME                       = 'connector.log';
    ...
    {
        $this->br_errors = [
            'authentification' => "Connector (v.{$this->module_version}): Authentication Error",
            'create_tmp_file' => "Connector (v.{$this->module_version}): Can't Create Temporary File",
            'open_tmp_file' => "Connector (v.{$this->module_version}): Can't Open Temporary File",
            'not_writeable_dir' => "Connector (v.{$this->module_version}): Temporary Directory specified in
                Connector settings doesn't exist or is not writeable",
            'temporary_file_exist_not' => "Connector (v.{$this->module_version}): Temporary File doesn't exist",
            'temporary_file_readable_not' => "Connector (v.{$this->module_version}): Temporary File isn't
                readable",
            'file_uid_mismatch' => "Connector (v.{$this->module_version}): SAFE MODE Restriction in effect.
            ...
            'open_basedir' => "Connector (v.{$this->module_version}): Please create local Temporary Directory,
                see \$temporary_dir variable in bridge.php",
            'checksum_dif' => 'Checksums are different',
            'ip_check' => "Connector (v.{$this->module_version}): Add your IP to allowed list to run connector,
                please",
