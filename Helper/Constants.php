...
class Constants
{
    ...
    const TABLE_SESSION_KEYS        = 'connector_session_keys';
    const TABLE_FAILED_LOGIN        = 'connector_failed_login';
    const CONFIG_PATH_SETTINGS      = 'emagicone/connector/settings';
    const CRYPT_KEY                 = "EMO_connector\0\0\0\0\0";
    const CRYPT_IV                  = 'EMO_connec';
