...
namespace Emagicone\Connector\Controller\Adminhtml\Settings;
...
/**
 * Class Save
 * @package Emagicone\Connector\Controller\Adminhtml\Settings
 */
class Save extends \Magento\Backend\App\Action
{
    private function getPreparedSettingsToStore($settings)
    {
        ...
        $dataToStore = [
            ...
            'exclude_db_tables' =>
                isset($settings['connector_exclude_db_tables_checked'])
                    && !empty($settings['connector_exclude_db_tables_checked'])
                ? implode(';', $settings['connector_exclude_db_tables_checked'])
                : '',
        ];
