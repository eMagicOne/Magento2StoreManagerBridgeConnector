...
namespace Emagicone\Connector\Block\Adminhtml\Settings\Edit\Tab;
...
class Main extends Generic implements TabInterface
{
    ...
    public function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('fieldset_sm_settings', ['legend' => __('Store Manager Connector Settings')]);
        ...
        $renderer = $this->getLayout()->createBlock('Magento\Backend\Block\Widget\Form\Renderer\Fieldset\Element')
            ->setTemplate('Emagicone_Connector::settings/edit/form/renderer/allow_compression.phtml');
        ...
        $renderer = $this->getLayout()->createBlock('Magento\Backend\Block\Widget\Form\Renderer\Fieldset\Element')
            ->setTemplate('Emagicone_Connector::settings/edit/form/renderer/exclude_db_tables.phtml');
        $contentField->setRenderer($renderer);
