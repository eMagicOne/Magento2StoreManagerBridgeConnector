 ...
 */
class GetFile extends AbstractTask implements TaskInterface
{
    /**
     * @var UrlInterface
     */
    ...
    public function proceed()
    {
        ...
        $filePath = $this->getHelper()->getMediaDir() .
            '/catalog/' . $this->_requestData['entity_type'] . $this->_requestData['filename'];
